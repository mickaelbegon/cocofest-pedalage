...
| `acados_rho7_recovery` | ACADOS reduced résistant jusqu'au checkpoint certifié après RHO 6, puis IPOPT/Radau-5 sur le RHO 7 gelé | ACADOS doit recertifier le primal injecté; aucun fallback ne peut avancer ce RHO |
